...
import { INPUT_FIELDS_PERSONAL_INFO } from "../constants/constants";
...
const Settings = () => {
  ...
  //     );
  // };
  const renderInputField = (field: InputFieldProps) => (
    <div key={field.name} className="mb-5.5">
        ...
        <div className="grid grid-cols-5 gap-8">
          <div className="col-span-5 xl:col-span-3">
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-7">
                <form action="#">
                  {INPUT_FIELDS_PERSONAL_INFO.map(renderInputField)}
