...
const SignIn = () => {
  ...
  return (
    <>
      <div className="h-screen rounded-sm border border-stroke bg-black shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2 mt-20">
            <div className="py-17.5 px-26 text-center">
              <img src="https://codify.pk/assets/images/logo.webp" alt="" />
            </div>
          </div>

          <div className="w-full  dark:border-strokedark xl:w-1/2 mt-20 ">
