...
const AllottedAssetsTable = () => {
    ...
    const openAllotAssetModal = () => {
        setShowAllotAssetModal(true)
    }
    const closeAllotAssetModal = () => {
        setShowAllotAssetModal(false)
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div className="flex justify-between py-6 px-4 md:px-6 xl:px-7.5">
                <h4 className="text-xl font-semibold text-black dark:text-white">
                    Alloted Company Assets
                </h4>


                <div className=''>
                    <div className='flex gap-8 mb-5'>
                        <PrimaryButton onClick={openAllotAssetModal}>Allot Assets</PrimaryButton>
                    </div>
                </div>
            </div>
            ...
            {showAllotAssetModal ? (
                <AllotAssetsModal onClose={closeAllotAssetModal} />
            ) : null}
...
export default AllottedAssetsTable;
